...
var ASM_CONSTS = {
  96968: () => { if (document.fullscreenElement) return 1; },  
 97014: () => { return document.getElementById('canvas').width; },  
 97066: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97134: () => { document.exitFullscreen(); },  
 97161: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97234: () => { if (document.fullscreenElement) return 1; },  
 97280: () => { return document.getElementById('canvas').width; },  
 97332: () => { return screen.width; },  
 97357: () => { document.exitFullscreen(); },  
 97384: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97517: () => { return window.innerWidth; },  
 97543: () => { return window.innerHeight; },  
 97570: () => { if (document.fullscreenElement) return 1; },  
 97616: () => { return document.getElementById('canvas').width; },  
 97668: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97736: () => { if (document.fullscreenElement) return 1; },  
 97782: () => { return document.getElementById('canvas').width; },  
 97834: () => { return screen.width; },  
 97859: () => { return window.innerWidth; },  
 97885: () => { return window.innerHeight; },  
 97912: () => { if (document.fullscreenElement) return 1; },  
 97958: () => { return document.getElementById('canvas').width; },  
 98010: () => { return screen.width; },  
 98035: () => { document.exitFullscreen(); },  
 98062: () => { if (document.fullscreenElement) return 1; },  
 98108: () => { return document.getElementById('canvas').width; },  
 98160: () => { return parseInt(document.getElementById('canvas').style.width); },  
 98228: () => { document.exitFullscreen(); },  
 98255: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98313: () => { return screen.width; },  
 98338: () => { return screen.height; },  
 98364: () => { return window.screenX; },  
 98391: () => { return window.screenY; },  
 98418: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98471: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98542: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98599: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98855: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98926: () => { if (document.fullscreenElement) return 1; },  
 98972: () => { return window.innerWidth; },  
 98998: () => { return window.innerHeight; },  
 99025: () => { if (document.pointerLockElement) return 1; }
};
